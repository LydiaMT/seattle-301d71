...
function displayPics(){
  ...
  // This code threw an error becuase "rando" was declared locally via the variable assignment `let` in the while{} constructor code block.
  // Had console.log(rando) been declared inside the code block, it would have ran without throwing an error.
  console.log(viewed);
